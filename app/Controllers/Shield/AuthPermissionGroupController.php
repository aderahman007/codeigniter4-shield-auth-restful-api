...
class AuthPermissionGroupController extends BaseApiController
{
    protected $format       = 'json';
    protected $modelName    = 'App\Models\Shield\AuthPermissionGroupModel';
    ...
    {
        $query = $this->model->select('auth_permission_groups.id, group_name, permission_name, authorization, auth_permission.description')
        ...
        $msg = [
            'status'        => 200,
            'message'       => 'Semua data auth permission group',
            'data'          => ['auth_permission_group' => $query],
        ];
        ...
        if (!$validasi) {
            $msg = [
                ...
                'data' => [
                    ...
                    'permission' => $this->validation->getError('permission'),
                ]
            ];
        } else {
            $data = [
                'group_id' => strtolower($this->request->getVar('group_id')),
